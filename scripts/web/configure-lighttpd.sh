...
sudo cp /vagrant/resources/lighttpd/block temp$2 -f
...
# Copy File
sudo cp temp$2 /etc/lighttpd/conf-available/$2.conf
sudo ln -fs /etc/lighttpd/conf-available/$2.conf /etc/lighttpd/conf-enabled/
# Remove File
sudo rm temp$2 -f
